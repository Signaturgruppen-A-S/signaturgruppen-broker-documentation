...
|--------|------|--------|
| EU Age Verification       | eudi     | EUDI AV. Supports any national implementation of the EUDI AV scheme, such as the danish **AltID**.        |
| AltID       | eudi      | AltID is the danish national wallet based on EUDI.         |
